...
scores = []
frame_rate_calc = 1
def predict(interpreter, input_frame, update_prediction=False):
    global boxes, classes, scores, frame_rate_calc
    ...
    # frame1 = videostream.read() ####getting from input instead
    # frame = frame1.copy()
    ...
    # return the frame that have the result drawn
    return frame
